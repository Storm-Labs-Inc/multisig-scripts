...
contract Script is CommunityMultisigScript, StdAssertions {
    ...
    function run(bool shouldSend) public override {
        ...
        // 100k USD deposit limit with 1 USD per USDS
        uint256 usds1MaxDeposit = 100_000e18;

        // ================================ START BATCH ===================================
        _deployGaugesGrantRolesDepsoitLimitFeeSplit(
            MAINNET_YVUSDS_1_GAUGE,
            usds1,
            usds1MaxDeposit,
        ...
        returns (address[] memory targets, uint256[] memory values, bytes[] memory payloads)
    {
        ...
        addToBatch(
            ...
            0,
            abi.encodeCall(AccessControl.grantRole, (MANAGER_ROLE, BOOSTIES_SILVERBACK_AWS_ACCOUNT))
        );
        // Grant manager role to the relayer for reward forwarding
        addToBatch(
