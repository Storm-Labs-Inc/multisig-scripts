...
contract Script is CommunityMultisigScript, StdAssertions {
    function run(bool shouldSend) public override {
        ...
        // amounts from: https://docs.cove.finance/ecosystem/token/info#epoch-1
        uint256 coveYFIRewardAmount = 3_500_000 ether;
        uint256 coveBoostiesV2LPTokenRewardAmount = 750_000 ether;
        uint256 coveBoostiesV3LPTokenRewardAmount = 750_000 ether;
